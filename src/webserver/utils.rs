...
///
/// assert_eq!(Some("path/to/file.html"), parse_filename_from_request(&line));
///
...
pub fn get_response_headers_from_file(filepath: &PathBuf) -> Option<String> {
